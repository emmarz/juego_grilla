...
/*Clase original, con ella se puede ejecutar directamente e ir probando la GUI*/
public class MainWindow {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 494, 379);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(new BorderLayout(0, 0));
		
		body_center = new JPanel();
		frame.getContentPane().add(body_center, BorderLayout.CENTER);
		...
		frame.getContentPane().add(body_left, BorderLayout.WEST);
		
		body_right = new JPanel();
		frame.getContentPane().add(body_right, BorderLayout.EAST);
